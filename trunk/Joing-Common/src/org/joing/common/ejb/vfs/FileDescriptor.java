...
package org.joing.common.ejb.vfs;
...
public class FileDescriptor implements Serializable {
    ...
    //---------------------------------------------
    private static final int ALTERABLE = 1;
    private static final int DELETEABLE = 2;
    private static final int DUPLICABLE = 3;
    private static final int EXECUTABLE = 4;
    private static final int HIDDEN = 5;
    private static final int MODIFIABLE = 6;
    private static final int PUBLIC = 7;
    private static final int READABLE = 8;
    private static final int LOCKED = 9;
    private static final int IN_TRASHCAN = 10;
