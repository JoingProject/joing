...
{ // TODO: Mirar aquí: http://java.sun.com/j2se/1.5.0/docs/guide/net/properties.html
    ...
    {
        return PDEManager.getInstance().getRuntime().getIcon( ProxyConfig.class, "proxy.png", nWidth, nHeight );
    }
