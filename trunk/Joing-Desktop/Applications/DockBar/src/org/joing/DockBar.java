...
/**
 * A Desktop Launcher Bar "a la" Apple OS.
 *
 * @author Francisco Morero Peyrona
 */
public class DockBar extends JPanel
{
    ...
    public int getMinIconDiameter()
    {
        return nMinIconSize;
    }

    public void setMinIconDiameter( int nMinIconSize )
    {
        if( nMinIconSize < 16 )
            nMinIconSize = 16;
    ...
    public int getMaxIconDiameter()
    {
        return nMaxIconSize;
    }

    public void setMaxIconDiameter( int nMaxIconSize )
    {
        if( nMaxIconSize < 16 )
            nMaxIconSize = 16;
