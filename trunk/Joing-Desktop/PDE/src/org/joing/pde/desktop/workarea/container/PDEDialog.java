 ...
 */
public class PDEDialog extends JInternalFrame
{ // TODO: hay que mejorar esta clase: estudiar la JOptionPane
    private JOptionPane pane;
    
    //------------------------------------------------------------------------//
    
    public PDEDialog( String sTitle )
    {
        super( sTitle );
    }
    
    public PDEDialog( String sTitle, JPanel panel, Object[] values, Object initialValue )
    {
        this( sTitle, new JOptionPane( panel, JOptionPane.PLAIN_MESSAGE, JOptionPane.NO_OPTION, null, values, initialValue ) );
    }
    
    public PDEDialog( String sTitle, JOptionPane pane )
    {
        super( sTitle );
        setPane( pane );
    }
