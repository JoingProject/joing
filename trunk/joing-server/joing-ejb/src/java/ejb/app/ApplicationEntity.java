 ...
 * 
 * Created on 20-ago-2007, 10:49:40
 * 
...
public class ApplicationEntity implements Serializable {
    ...
    public ApplicationEntity( String application, String version )
    {
        this.applicationEntityPK = new ApplicationEntityPK( application, version );
    }
    ...
    protected void setApplicationEntityPK( ApplicationEntityPK applicationEntityPK )
    {
        this.applicationEntityPK = applicationEntityPK;
    }
    ...
    public boolean equals( Object object )
    {
        ...
        if( (this.applicationEntityPK == null && other.applicationEntityPK != null) || (this.applicationEntityPK != null && !this.applicationEntityPK.equals( other.applicationEntityPK )) )
            return false;
        return true;
    }
