...
public final class PlatformRuntime
{
    ...
    private static PlatformRuntime instance = new PlatformRuntime();
     ...
     */
    static PlatformRuntime getRuntime()
    {           
        return instance;
    }
    ...
    /**
     * Load and fills the current Runtime values.
     */
    public void init(Properties clientProp) {
        // Gets the working values
        sServerBaseURL =
