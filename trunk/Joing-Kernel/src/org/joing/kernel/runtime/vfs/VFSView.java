...
public class VFSView
{
     ...
     */
    public static final char   separatorChar     = VFSFileBase.separatorChar;
    /**
     ...
     * @see     java.lang.System#getProperty(java.lang.String)
     */
    public static final char   pathSeparatorChar = VFSFileBase.pathSeparatorChar;
    /**
     * The system-dependent path-separator character.  This field is
     * initialized to contain the first character of the value of the system
     * property <code>path.separator</code>.  This character is used to
    ...
    public VFSFile createNewFolder( VFSFile vfsParentDir ) throws IOException
    {
        ...
        else                    // A new directory has to be created inside passed dir
        {
            ...
            vfsNewFolder    = org.joing.kernel.jvmm.RuntimeFactory.getPlatform().
                                  getBridge().getFileBridge().createDirectory( sParent, null );
        }
    ...
    public VFSFile createNewFile( VFSFile vfsParentDir ) throws IOException
    {
        ...
        String  sParent = vfsParentDir.getAbsolutePath();
        VFSFile file    = org.joing.kernel.jvmm.RuntimeFactory.getPlatform().getBridge().
                              getFileBridge().createFile( sParent, null, false );
