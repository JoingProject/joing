...
/**
 * A PDF Viewer application for Joing
 * @author RuGI
 */
public class JoingPDFViewer extends JPanel
    ...
    public final static String TITLE = "Joing PDF Viewer. ";
    /** The current PDFFile */
    PDFFile curFile;
    ...
    public ImageIcon getIcon(String name) {
        ...
        URL url = null;
        try {            
            url = JoingPDFViewer.class.getResource(name);            
    ...
    public void showInFrame() {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                frame.setIcon(JoingPDFViewer.this.getIcon("/org/joing/pdfviewer/images/pdf.png").getImage());
...
//                f.setIconImage(JoingPDFViewer.this.getIcon("/org/joing/pdfviewer/images/pdf.png").getImage());
//                f.pack();
