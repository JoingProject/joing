...
ALTER TABLE APP_DESCRIPTIONS
     ADD CONSTRAINT FK_APP_DESCRIPTIONS_APPLICATIONS
         FOREIGN KEY (ID_APPLICATION)
         REFERENCES APPLICATIONS (ID_APPLICATION)
         ON DELETE CASCADE;

ALTER TABLE APP_DESCRIPTIONS
     ADD CONSTRAINT FK_APP_DESCRIPTIONS_LOCALES
         FOREIGN KEY (ID_LOCALE)
         REFERENCES LOCALES (ID_LOCALE)
         ON DELETE CASCADE;
...
ALTER TABLE APP_PREFERRED
     ADD CONSTRAINT FK_APPPREFERRED_APPS
         FOREIGN KEY (ID_APPLICATION)
         REFERENCES APPLICATIONS (ID_APPLICATION)
         ON DELETE CASCADE;
