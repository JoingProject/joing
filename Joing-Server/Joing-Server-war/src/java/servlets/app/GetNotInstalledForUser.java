/*
 * GetNotInstalledForUser.java
 *
 * Created on 30 de junio de 2007, 12:30
 */
 ...
 * @version
 */
public class GetNotInstalledForUser extends HttpServlet
{
    @EJB
    ...
    throws ServletException, IOException
    {
        ...
        try
        {
            ...
            // Process request
            List<AppGroup> apps = applicationManagerBean.getNotInstalledForUser( sSessionId, environ, groupKey );
