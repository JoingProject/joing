 ...
 */
package org.joing.examples.client.dockbar;
...
import org.joing.desktop.dockbar.DockBar;
...
public class Main extends JFrame
{
    ...
    public Main()
    {
        ...
        dockBar  = new DockBar();
        dockBar.add( getIcon( "acroread.png" ) );
        dockBar.add( getIcon( "amarok.png" ) );
        dockBar.add( getIcon( "camera.png" ) );
        dockBar.add( getIcon( "juk.png" ) );
        dockBar.add( getIcon( "kcalc.png" ) );
        dockBar.add( getIcon( "knotify.png" ) );
        dockBar.add( getIcon( "kview.png" ) );
